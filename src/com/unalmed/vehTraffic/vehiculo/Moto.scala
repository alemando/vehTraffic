...
class Moto private (val pla : String, private var _pos : Punto, private var _vel : Velocidad) extends Vehiculo(pla)(_pos, _vel){
...
object Moto{
  ...
  def apply(posicion: Punto, velocidad: Velocidad):Moto={
    new Moto(placa, posicion, velocidad)
  }
