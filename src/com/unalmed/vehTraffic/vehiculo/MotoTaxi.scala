...
class MotoTaxi private (val pla : String, private var _pos : Punto, private var _vel : Velocidad) extends Vehiculo(pla)(_pos,_vel){
...
object MotoTaxi{
  ...
  def apply(posicion: Punto, velocidad: Velocidad):MotoTaxi={
    new MotoTaxi(placa, posicion, velocidad)
  }
